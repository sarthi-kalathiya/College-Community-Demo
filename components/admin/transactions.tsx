              ...
              <table className="w-full">
                <thead className="bg-muted">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium">Platform Fee</th>
                ...
                <tbody>
                  {transactions.map((transaction) => (
                    <tr key={transaction.id} className="border-t">
                      ...
                      <td className="px-4 py-3">{transaction.communityName}</td>
                      <td className="px-4 py-3 font-medium">${transaction.amount.toFixed(2)}</td>
                      <td className="px-4 py-3 text-muted-foreground">${transaction.platformFee.toFixed(2)}</td>
